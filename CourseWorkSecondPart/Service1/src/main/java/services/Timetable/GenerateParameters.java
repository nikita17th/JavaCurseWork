...
@RestController
public class GenerateParameters extends Application {
    ...
    private static boolean startJavafx = true;
    ...
    @GetMapping("/generatePerformance")
    public static String getPerformanceCranes() {
        ObjectWriter ow = new ObjectMapper().writer().withDefaultPrettyPrinter();
        String json = null;
        try {
            json = ow.writeValueAsString(new
                    PerformanceCranes(performanceLoose, performanceLiquid, performanceContainer));
    ...
    public void start(Stage stage) throws Exception {
        URL url = new File("src/main/java/services/Timetable/GraphicsInterface.fxml").
                toURI().toURL();
